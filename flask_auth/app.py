# JWT JSON Web Token   An Autentication Page
...
class User(db.Model, UserMixin):
    ...
    def __repr__(self):
        return f'Username(username={self.username}, password={self.password})'

    def __init__(self, username, password):
        self.username = username                 #   Data Serialization
...
@app.route('/')
def home():
    return render_template('home.htm l')
